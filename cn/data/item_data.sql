...
insert into item_data values (31143, '智（魔法少女）的记忆碎片', '封印着香澄（魔法）记忆碎片的道具。收集一定数量后，可以解放角色隐藏的神秘力量。', 1, 11, 31143, 0, 9999, 3464122, 0, '2022/11/21 11:00:00', '2099/12/31 23:59:59');

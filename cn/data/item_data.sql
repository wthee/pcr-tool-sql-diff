...
insert into item_data values (21003, '优衣（礼服）专用辉光球', '优衣（礼服）专用的辉光球。角色的属性值可以强化至等级180/品级19。', 1, 21, 3, 0, 999, 0, 0, '2023/01/31 11:00:00', '2099/12/31 23:59:59');
insert into item_data values (21004, '莉玛（灰姑娘）专用辉光球', '莉玛（灰姑娘）专用的辉光球。角色的属性值可以强化至等级180/品级19。', 1, 21, 5, 0, 999, 0, 0, '2023/02/28 11:00:00', '2099/12/31 23:59:59');
...
insert into item_data values (31155, '可可萝（礼服）的记忆碎片', '封印着可可萝（礼服）记忆碎片的道具。收集一定数量后，可以解放角色隐藏的神秘力量。', 1, 11, 31155, 0, 9999, 1432152, 0, '2023/01/31 11:00:00', '2099/12/31 23:59:59');
insert into item_data values (31156, '优衣（礼服）的记忆碎片', '封印着优衣（礼服）记忆碎片的道具。收集一定数量后，可以解放角色隐藏的神秘力量。', 1, 11, 31156, 0, 9999, 7201142, 0, '2023/01/31 11:00:00', '2099/12/31 23:59:59');
insert into item_data values (31157, '香澄（夏日）的记忆碎片', '封印着香澄（夏日）记忆碎片的道具。收集一定数量后，可以解放角色隐藏的神秘力量。', 1, 11, 31157, 0, 9999, 1022122, 0, '2023/02/23 11:00:00', '2099/12/31 23:59:59');
...
insert into item_data values (31806, '凯露（公主）的记忆碎片', '封印着凯露（公主）记忆碎片的道具。收集一定数量后，可以解放角色隐藏的神秘力量。', 1, 11, 31806, 0, 9999, 1170142, 0, '2023/02/28 11:00:00', '2099/12/31 23:59:59');

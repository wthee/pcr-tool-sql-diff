CREATE TABLE `growth_restriction_unit` (`id` INTEGER, `growth_id` INTEGER, `unit_id` INTEGER);
...
insert into growth_restriction_unit values (21, 27, 128301);
insert into growth_restriction_unit values (22, 28, 128801);

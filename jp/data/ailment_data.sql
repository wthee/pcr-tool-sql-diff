...
insert into ailment_data values (34, 8, 14, 'スタン（別枠）');
insert into ailment_data values (35, 9, 7, '毒（別枠）');
insert into ailment_data values (36, 9, 8, '呪い（別枠）');
insert into ailment_data values (37, 11, 2, '混乱（別枠）');
...
insert into ailment_data values (48, 79, 10, '行動時界雷ダメージ');

CREATE TABLE `clan_invite_level_group` (`level_group_id` INTEGER, `team_level_from` INTEGER, `team_level_to` INTEGER);
...
insert into clan_invite_level_group values (58, 296, 298);
insert into clan_invite_level_group values (59, 299, -1);

...
insert into dungeon_area values (31010, 1, '四彩の霊峰', '四季彩りし霊狐の仙境', 0, 11062014, 4003021, 4003022, 501010010, 10, 0, 0, 0, 100, 0);
...
insert into dungeon_area values (32010, 1, 'スペシャルダンジョン', '期間限定ダンジョンの踏破に挑戦', 31006, 0, 0, 0, 0, 10, 0, 0, 0, 100, 100);

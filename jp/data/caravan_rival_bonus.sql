...
insert into caravan_rival_bonus values (10007, 5, 2, 2, 15, -1, 22, 53003, 8, '');
insert into caravan_rival_bonus values (10008, 5, 1, 1, 1, 14, 22, 53003, 5, '');
insert into caravan_rival_bonus values (10009, 5, 0, 0, 0, 0, 23, 52019, 2, 'ワカナの施し');

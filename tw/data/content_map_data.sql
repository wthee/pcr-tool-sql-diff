CREATE TABLE `content_map_data` (`content_map_id` INTEGER, `name` TEXT, `map_type` INTEGER, `area_id` INTEGER, `condition_quest_id` INTEGER, `quest_position_x` INTEGER, `quest_position_y` INTEGER, `icon_id` INTEGER, `system_id` INTEGER, `start_time` TEXT, `end_time` TEXT);

CREATE TABLE `dvs_story_data` (`sub_story_id` INTEGER, `original_event_id` INTEGER, `title` TEXT, `sub_title` TEXT, `detail_title` TEXT, `detail_description` TEXT, `dvs_story_type` INTEGER, `is_last` INTEGER, `condition_quest_id` INTEGER, `reward_type_1` INTEGER, `reward_id_1` INTEGER, `reward_count_1` INTEGER, `reward_type_2` INTEGER, `reward_id_2` INTEGER, `reward_count_2` INTEGER);

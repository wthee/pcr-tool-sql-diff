CREATE TABLE `shiori_quest_area` (`area_id` INTEGER, `event_id` INTEGER, `area_name` TEXT, `map_type` INTEGER, `sheet_id` TEXT, `que_id` TEXT, `area_disp` INTEGER, `map_id` INTEGER, `scroll_width` INTEGER, `scroll_height` INTEGER, `open_tutorial_id` INTEGER, `tutorial_param_1` TEXT, `tutorial_param_2` TEXT, `additional_effect` INTEGER);
